#
#  Be sure to run `pod spec lint EMSpinnerButton.podspec' to ensure this is a
...
Inspired by the Starbucks app
  ...
  s.author             = { "egmoll7" => "egmoll7@gmail.com" }
  ...
  s.source       = { :git => "http://github.com/egmoll7/EMSpinnerButton.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "EMSpinnerButton", "EMSpinnerButton/**/*.{h,m,swift}"
